...
LastRide.editor.prototype = {
  init: function() {
    ...
    this.saveMapInfoTEXT = this.game.add.text(10, 110, 'Press O to save the map(You can only save once)', { fill: '#ffffff', font: '14pt Arial' } );
    this.info.push(this.saveMapInfoTEXT);

    this.ToggleTextINFO = this.game.add.text(10, 130, 'Press I to toggle info', { fill: '#ffffff', font: '14pt Arial' } );
